...
export type { CapTable } from './models/CapTable';
export type { CapTableEntry } from './models/CapTableEntry';
export type { CreateFundRequest } from './models/CreateFundRequest';
